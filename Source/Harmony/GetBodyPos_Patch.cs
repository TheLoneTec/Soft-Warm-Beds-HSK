...
namespace SoftWarmBeds
{
    ...
    [HarmonyPatch(typeof(PawnRenderer), "GetBodyPos", new Type[] { typeof(Vector3), typeof(PawnPosture), typeof(bool) }, new ArgumentType[] { ArgumentType.Normal, ArgumentType.Normal, ArgumentType.Out })]
